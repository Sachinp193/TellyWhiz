...
// Mock for '../tvdb'
vi.mock('@api/tvdb', () => { // Changed to alias
...
import app from '@api/index'; // Changed to alias
import { storage } from '@api/storage'; // Changed to alias
import { db } from '@db/index'; // Changed to alias
